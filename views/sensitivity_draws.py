# Feeds Supplementary Table S14 (five redrawn negative samples). Needs ASRS_DIR (the CSV export) to build the pool once; pool_views.jsonl.gz is not shipped (107 MB).
...
each (frozen constants from l1_build_task / views_w2v / views_train).
...
POOL=os.path.join(HERE,'pool_views.jsonl.gz')
